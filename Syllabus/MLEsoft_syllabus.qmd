...
-   All sessions in person (102 Urban Planning and Lanscape Architecture Building, MSU and virtual via Zoom using link information sent by email (if you need the link contact instructor).
...
Prior to the course start you should have signed up for a guest ID for your email account. This is needed to allow you to access to the course media space (recording site).
...
-   Session 2: First use of RTMB and Derivatives (will be completed day 1 (late morning/afternoon)
