...
subtitle: Lesson 3 - Controlling the search and assessing uncertainty <br> [Click here to view presentation online](https://qfcatmsu.github.io/MLE-RTMB/lesson3/MLE_lec3.html){style="position:absolute;top:40%lesson1;left:35%;font-size:20px;"}
author: Jim Bence
...
-   One approach: base and offsets
    -   Estimate base level (gear, year, location) and offsets
        -   Two gears: estimate logqgill and offtrap, logqgill is the
            log-scale gill net catchability. logqtrap=logqgill+offset
        -   for year-effects, estimate YE0, offsets for nyears-1 other
            years. Then YE\[1\]=YE0, and (i\>1) YE\[i\]=YE_0+offset\[i-1\]
-   Alternative is estimate mean and deviations from mean
    -   Trickier because for n levels you can estimate the mean and n-1
        deviations. The last deviation  is calculated.
...
-   Some have suggested constraining fit with penalty so desired values of
    ...
    and its not implemented in TMB.
